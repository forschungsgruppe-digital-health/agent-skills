...
| provenance | P1 the rendered site reports the template package it was built with · P2 the skeleton's module-template ref is the latest release · P3 the IG Publisher version matches the workflow pin · P4 the source guide was pinned to a published version, not "current" | {n} | {n} | {n} |
